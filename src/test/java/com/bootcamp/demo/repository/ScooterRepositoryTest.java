...
class ScooterRepositoryTest {
    ...
    void shouldInsertScooter() {
        ...
        this.repository.insertScooter(new Scooter("doc1", "serial1", "brand1", "1", 2001, 1.1f, State.IN_USE));
    }
    ...
    void shouldReadScooter() throws ExecutionException, InterruptedException {
        ...
        assertEquals(scooters.get(0), new Scooter("IN_USE", "IN_USE", "IN_USE", "1", 123, 1.1, State.IN_USE));
