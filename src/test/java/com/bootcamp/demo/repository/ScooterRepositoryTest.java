...
class ScooterRepositoryTest {
    ...
    void shouldInsertScooter() {
        ...
        this.repository.insertScooter(new Scooter("doc1", "serial1", "brand1", "1", 2001, 1.1f, State.IN_USE, "-27.409918931537973", "128.06496968889238"));
    }
    ...
    void shouldReadScooter() throws ExecutionException, InterruptedException {
        ...
        when(queryDocumentSnapshotMock.toObject(any())).thenReturn(new Scooter("IN_USE", "IN_USE", "IN_USE", "1", 123, 1.1, State.IN_USE,"-27.409918931537973","128.06496968889238"));
